export const environment = {
  ...
  GOOGLE_ANDROID_CLIENT_ID: '1067170807523-skqbcodkktsctbuvkltjosnaok60j7l2.apps.googleusercontent.com', // Android client ID - needs to be configured in Google Console
